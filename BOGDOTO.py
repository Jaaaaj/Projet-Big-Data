...
X_train, X_test, y_train, y_test = train_test_split(V_final, yn, test_size=0.33,random_state = 0)
...
reg = linear_model.BayesianRidge(n_iter=400, tol=0.01, alpha_1=1e-02, alpha_2=1e-02, lambda_1=1e-02, lambda_2=1e-05)
reg.fit(X_train, y_train)
print("Training score R^2 =", reg.score(X_train, y_train)) 
print("Test score R^2 =", reg.score(X_test, y_test))
...
print("Training score R^2 =", ransac.score(X_train, y_train)) 
print("Test score R^2 =", ransac.score(X_test, y_test))
...
print("Training score R^2 =", svr.score(X_train, y_train)) 
print("Test score R^2 =", svr.score(X_test, y_test))
...
regr.fit(X_train, y_train)
print("Training score R^2 =", regr.score(X_train, y_train)) 
print("Test score R^2 =", regr.score(X_test, y_test))
...
print("Test score R^2 =", clf.score(X_test, y_test))
